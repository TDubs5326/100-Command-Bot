...
for (const file of commandFiles) {
    ...
    client.commands.set(command.name, command); //made by TDubs#5326
}
...
client.once('ready', () => {
    ...
    client.user.setActivity('Made by TDubs#5326', {
        type: "WATCHING"
    });
});
...
client.on('message', async message => {
    ...
    try {
        ...
        console.log(chalk.greenBright('[COMMAND]'), `${message.author.tag} used the command ` + commandName)//made by TDubs#5326
    } catch (error) {
        console.log(error);
